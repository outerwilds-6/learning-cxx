...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        }
        {
            ...
            ASSERT(vec[48] == vec[48], "Fill in the correct value.");
            ASSERT(vec[49] == vec[49], "Fill in the correct value.");
            ASSERT(vec[50] == vec[50], "Fill in the correct value.");
            ASSERT(vec[51] == vec[51], "Fill in the correct value.");
        }
    }
